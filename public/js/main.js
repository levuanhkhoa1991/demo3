(function($) {
    ...
    $(window).on('scroll', function() {
        ...
        if (scroll < 100) {
            $(".sticky-header").removeClassName("sticky");
        } else {
            $(".sticky-header").addClassName("sticky");
        }
    });
    ...
    $(window).on('scroll', function() {
        var scroll = $(window).scrollTop();
        if (scroll < 100) {
            $(".seperate-sticky-bar").removeClassName("sticky");
        } else {
            $(".seperate-sticky-bar").addClassName("sticky");
        }
    });
    ...
    $('#search, #search button.close').on('click', function(event) {
        if ( event.target.classNameName == 'close' ) {
    ...
    (function() {
        ...
        $offCanvasToggle.on('click', function(e) {
            ...
            $body.addClassName('offcanvas-open');
            $($target).addClassName('offcanvas-open');
        ...
        $('.offcanvas-close, .offcanvas-overlay').on('click', function(e) {
            e.preventDefault();
            $body.removeClassName('offcanvas-open');
            $offCanvas.removeClassName('offcanvas-open');
    ...
    function mobileOffCanvasMenu() {
        ...
        $offCanvasNav.on('click', 'li a, .offcanvas-menu-expand', function(e) {
            var $this = $(this);
            if ($this.attr('href') === '#' || $this.hasClassName('offcanvas-menu-expand')) {
                e.preventDefault();
