            ...
            <div className="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div className="col-md-6">
                    <div className="content" data-aos="fade-up"  data-aos-delay="200">
                        ...
                        <h5 className="semi-title">We believe that every project existing in digital world is a result of an idea and every idea has a cause.</h5>
                ...
                <div className="row mb-n6">
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="0">
                            <div className="team-img">
                                <img className="img-fluid" src="/images/team/leader1.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="200">
                            <div className="team-img">
                                <img className="img-fluid" src="/images/team/leader2.png" alt="" />
                            </div>
                            <div className="team-content">
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="400">
                            <div className="team-img">
                                <img className="img-fluid" src="/images/team/leader3.png" alt="" />
                            </div>
                            <div className="team-content">
                                <h6 className="team-name font--bold mt-5">Missa Santos</h6>
                    ...
                    <div className="col-xl-3 mb-5">
                        <div className="team-single" data-aos="fade-up"  data-aos-delay="600">
                            <div className="team-img">
                                <img className="img-fluid" src="/images/team/leader4.png" alt="" />
                            </div>
                            <div className="team-content">
                            ...
                            <div className="swiper-container company-logo-slider">
                                <div className="swiper-wrapper">
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img  className="img-fluid" src="/images/company-logo/company-logo-1.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-2.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-3.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-4.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-5.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-6.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-7.png" alt="" /></div>
                                    </div>
                                    <div className="company-logo-single-item swiper-slide">
                                        <div className="image"><img className="img-fluid" src="/images/company-logo/company-logo-8.png" alt="" /></div>
                                    </div>
                                </div>
                            </div>
